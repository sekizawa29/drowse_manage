...
export default function SettingsPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 space-y-3 md:space-y-4 p-3 md:p-8 pt-6 flex items-center justify-center">
  ...
  return (
    <div className="flex-1 space-y-3 md:space-y-4 p-3 md:p-8 pt-6">
      <div>
        <h2 className="text-xl md:text-3xl font-bold tracking-tight">設定</h2>
        <p className="text-sm md:text-base text-muted-foreground">アカウント設定やシステム設定を管理します。</p>
      </div>
      <Tabs defaultValue="account" className="space-y-3 md:space-y-4">
        <TabsList className="w-full">
          <TabsTrigger value="account" className="flex-1 text-xs md:text-sm">アカウント</TabsTrigger>
          <TabsTrigger value="system" className="flex-1 text-xs md:text-sm">システム</TabsTrigger>
          <TabsTrigger value="notifications" className="flex-1 text-xs md:text-sm">通知</TabsTrigger>
          <TabsTrigger value="database" className="flex-1 text-xs md:text-sm">データベース</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="notifications" className="space-y-3 md:space-y-4">
          <Card>
            <CardHeader className="p-4 md:p-6">
        ...
        <TabsContent value="database" className="space-y-3 md:space-y-4">
          <DataMigration />
        </TabsContent>
      </Tabs>
    </div>
